...
def main():
    ...
    export_20ng(remove_headers, remove_footers, remove_quotes)


def export_20ng(remove_headers=False, remove_footers=False, remove_quotes=False):
    ...
    ng_train = fetch_20newsgroups(subset='train', remove=remove)
    ...
    ng_test = fetch_20newsgroups(subset='test', remove=remove)
