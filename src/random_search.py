...
def get_cnn_model(model_num, search_space):
    ...
    param_dist = {'model_' + model_num: 'CNN',
            ...
            'flex_' + model_num: (True, random.random() * (feature_selector['flex_amt_'][1] -
                                feature_selector['flex_amt_'][1]) + feature_selector['flex_amt_'][0]),
            'dropout_' + model_num: random.random() * (feature_selector['dropout_'][1] -
                                feature_selector['dropout_'][0]) + feature_selector['dropout_'][0],
    ...
    if feature_selector['no_reg'] == True:
